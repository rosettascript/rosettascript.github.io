...
const PATCH_NOTES = {
  "1.0.2": {
    version: "1.0.2",
    bugFixes: [
      "Fixed spacing checkbox being checked by default in Shoppables mode",
      "Removed all <br> tags from block elements (headers, paragraphs, lists)",
      "Fixed <p> tags remaining in list items"
    ],
    newFeatures: [
      "Added 'Spacing Rules' checkbox to Shoppables mode (unchecked by default)",
      "Added 'Add BR Before Read More' checkbox for custom spacing in Shoppables mode",
      "Added 'Add BR Before Sources' checkbox for custom spacing in Shoppables mode"
    ]
  }
};
      ...
      <DialogContent className="max-w-2xl border-primary/50 bg-background">
        ...
        <div className="flex justify-between items-center gap-2 pt-4 border-t">
          {patchNotes && (
            ...
            >
              <Link to={`/news/patch-${patchNotes.version.replace(/\./g, '-')}`} onClick={handleDismiss}>
